...
![尚硅谷-04-Message与提示词模板 第1页图片1](./images/尚硅谷-04-Message与提示词模板_p001_img01.png)
...
设定 AI 的行
{"role": "你是一个专业的
System SystemMessage(...) 为、角色、规
"system", ...} 数学老师"
则
{"role":
User HumanMessage(...) 用户输入 "什么是微积分？"
"user", ...}
{"role": "微积分是研究变
Assistant "assistant", AIMessage(...) AI 的回复 化率的数学分
...} 支..."
{"role": "tool", 工具执行的结 "今天北京天气晴
Tool ToolMessage(...)
...} 果 朗，万里无云"
### 1.4 举 例
**举例1：JSON格式**
...
![尚硅谷-04-Message与提示词模板 第8页图片1](./images/尚硅谷-04-Message与提示词模板_p008_img01.png)
...
返回的内容分析：
![尚硅谷-04-Message与提示词模板 第12页图片1](./images/尚硅谷-04-Message与提示词模板_p012_img01.png)
...
![尚硅谷-04-Message与提示词模板 第20页图片1](./images/尚硅谷-04-Message与提示词模板_p020_img01.png)

将下图置于代码所在的目录下（比如chapter04_message_prompt），命名为 image_test.png
![尚硅谷-04-Message与提示词模板 第20页图片2](./images/尚硅谷-04-Message与提示词模板_p020_img02.png)
...
![尚硅谷-04-Message与提示词模板 第24页图片1](./images/尚硅谷-04-Message与提示词模板_p024_img01.png)
