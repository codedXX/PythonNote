...
![尚硅谷-07-智能体 第1页图片1](./images/尚硅谷-07-智能体_p001_img01.png)
...
![尚硅谷-07-智能体 第2页图片1](./images/尚硅谷-07-智能体_p002_img01.png)
...
![尚硅谷-07-智能体 第5页图片1](./images/尚硅谷-07-智能体_p005_img01.png)
...
![尚硅谷-07-智能体 第6页图片1](./images/尚硅谷-07-智能体_p006_img01.png)
...
![尚硅谷-07-智能体 第10页图片1](./images/尚硅谷-07-智能体_p010_img01.png)
...
![尚硅谷-07-智能体 第11页图片1](./images/尚硅谷-07-智能体_p011_img01.png)
...
![尚硅谷-07-智能体 第15页图片1](./images/尚硅谷-07-智能体_p015_img01.png)

**举例2：接入内置工具**
绑定内置的TavilySearch搜索工具，可以借助Tavily进行网络搜索和信息爬取。
这里我们需要先在tavily官网注册并获得API-KEY（每月有免费额度）：https://www.tavily.com/。
![尚硅谷-07-智能体 第15页图片2](./images/尚硅谷-07-智能体_p015_img02.png)
...
![尚硅谷-07-智能体 第17页图片1](./images/尚硅谷-07-智能体_p017_img01.png)
...
![尚硅谷-07-智能体 第21页图片1](./images/尚硅谷-07-智能体_p021_img01.png)

**注意：**只给 Agent 需要的工具，工具太多会混淆。一般2-5 个工具最佳
### 4.2 工具调用流程分析
LangChain 的 Agent 会将 模型 与 工具 结合起来，在实现上由一个基于 LangGraph 的图结构来编排执
行流程，如下所示。
![尚硅谷-07-智能体 第21页图片2](./images/尚硅谷-07-智能体_p021_img02.png)
...
![尚硅谷-07-智能体 第22页图片1](./images/尚硅谷-07-智能体_p022_img01.png)

**举例：用户问题：“找出当前最流行的无线耳机并检查库存”的任务。**
![尚硅谷-07-智能体 第22页图片2](./images/尚硅谷-07-智能体_p022_img02.png)
...
作用于 大模型对象 作用于 Agent
**对象**
解析 每次模型调用 生成 AIMessage 时，进 仅在 Agent 决定 "任务结束" 并输出最终
时机 行解析 答案时解析
**数据**
模型 结构化对象 模型 工具 反思 ... 结构化对象
**流转**
**绑定**
使用 with_structured_output 使用 response_format 参数
**方式**
适用 单次、确定性 的任务（如提取字段、翻 多步、复杂推理 的任务（如查文档后汇
场景 译、分类） 总报表）
### 7.2 结构化输出的4种策略
...
当我们直接传入一个定义类型时，LangChain会自动包装为AutoStrategy，触发 自动选择策略 ：如果
...
运行后结果如下：
![尚硅谷-07-智能体 第59页图片1](./images/尚硅谷-07-智能体_p059_img01.png)
...
输出如下：
![尚硅谷-07-智能体 第66页图片1](./images/尚硅谷-07-智能体_p066_img01.png)

![尚硅谷-07-智能体 第66页图片2](./images/尚硅谷-07-智能体_p066_img02.png)
...
![尚硅谷-07-智能体 第67页图片1](./images/尚硅谷-07-智能体_p067_img01.png)


![尚硅谷-07-智能体 第68页图片1](./images/尚硅谷-07-智能体_p068_img01.png)
...
![尚硅谷-07-智能体 第70页图片1](./images/尚硅谷-07-智能体_p070_img01.png)
...
运行结果如下：
![尚硅谷-07-智能体 第70页图片2](./images/尚硅谷-07-智能体_p070_img02.png)
...
运行结果如下：
![尚硅谷-07-智能体 第71页图片1](./images/尚硅谷-07-智能体_p071_img01.png)
...
运行结果如下：
![尚硅谷-07-智能体 第71页图片2](./images/尚硅谷-07-智能体_p071_img02.png)
...
运行结果如下：
![尚硅谷-07-智能体 第72页图片1](./images/尚硅谷-07-智能体_p072_img01.png)
...
![尚硅谷-07-智能体 第73页图片1](./images/尚硅谷-07-智能体_p073_img01.png)
...
**模式 输出内容 使用场景**
每个步骤执行后，都会输出完整的状态 适用于每一步都要获取完整状态、状
values
信息 态持久化场景
用于监控Agent 执行进度，例如观察
updates（默 每个步骤执行后，只增量更新状态中发
Agent决定调用工具、工具执行结果
认） 生变化的内容
等步骤
实现类似ChatGPT 的打字机效果，为
输出流式返回的Token以及相关的元数
messages 聊天机器人等交互式应用提供最佳的
据（如：来自哪个节点model/tool）
实时体验
输出当前task任务开始和结束的时间，
tasks 该模式用于监控任务的生命周期
包含任务的结果和错误信息
与tasks模式类似，比task模式多输出
该模式用于调试、监控task任务的生
debug 任务步骤、时间戳、task类型
命周期
（task/task_result）
当检查点（checkpoint）被创建时会 用于需要状态持久化、工作流恢复或
checkpoints
触发输出，输出包含检查点中的状态 分布式执行跟踪的高级场景
用于输出业务逻辑相关的进度信息
通过get_stream_writer在工具或节点
custom （如“已处理10/100条记录”）、自定
内部自定义发送的数据
义日志或指标
...
下：
![尚硅谷-07-智能体 第76页图片1](./images/尚硅谷-07-智能体_p076_img01.png)
