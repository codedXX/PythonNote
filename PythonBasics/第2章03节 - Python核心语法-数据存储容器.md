...
* 特点：
  ...
  - `可以存储不同类型的元素`
  - `元素有序，可以重复，元素可以修改`![课件图示](./images/1.png)
...
* 介绍：切片是指对操作的数据截取其中一部分的操作。列表、字符串、元组都支持切片操作。![课件图示](./images/2.png)
...
*  字符串中的每一个字符元素都有其对应的下标（索引），通过元素对应的索引，就可以获取到对应的元素。![课件图示](./images/4.png)
